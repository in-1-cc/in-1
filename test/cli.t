...
has "$out" '-L|--local' "--help documents -L and --local"
has "$out" '-T|--temp' "--help documents -T and --temp"
...
has "$out" '-L' "--complete bash offers -L"
has "$out" '-T' "--complete bash offers -T"
...
has "$out" '-L' "--complete zsh offers -L"
has "$out" '-T' "--complete zsh offers -T"
...
has "$out" '-s L' "--complete fish offers -L"
has "$out" '-s T' "--complete fish offers -T"
